...
window.addEventListener('load', function () {
  console.log('js working'); // profile menu script

  var profileMenu = document.querySelector('.profile-menu');
  var profileMenuBtn = document.querySelector('.profile-btn');
  ...
  var searchResults = document.querySelector('.search-results__container--desktop .search-results');
  var searchResultShowsCol = document.querySelector('.search-results__container--desktop .search-results__shows');
  var searchResultMoviesCol = document.querySelector(' .search-results__container--desktop .search-results__movies');
